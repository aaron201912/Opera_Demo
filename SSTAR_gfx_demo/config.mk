...
INCLUDES  :=  -I$(ALKAID_PATH)/gfx_demo/common/ -I$(ALKAID_PATH)/project/release/include
LIB_PATH  := -L$(ALKAID_PATH)/gfx_demo/common/ -L$(ALKAID_PATH)/project/release/chip/p5/dispcam/common/glibc/6.4.0/mi_libs/dynamic -L$(ALKAID_PATH)/project/release/chip/p5/sigma_common_libs/glibc/6.4.0/dynamic/
LIB_NAME := -lm -lmi_vdec -lmi_sys -lmi_gfx -lmi_ao -lmi_common -ldl -lsstar -lcam_os_wrapper  -lcam_fs_wrapper
...
clean:
	...
	@rm -f $(C_OBJS)
	@rm -Rf $(OUTPUT_DIR)
	-rm -f $(ALKAID_PATH)/gfx_stable/common/libsstar.a
