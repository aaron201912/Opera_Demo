...
{
    //return;// not to write raw data to file
    FILE *fp = NULL;
    char sinkName[128] = {0};
...
void sink_yuv_surface(MI_GFX_Surface_t *pSurf,const char *data,const char  *name)
{
    //return;// not to write raw data to file
    FILE *fp = NULL;
    char sinkName[128] = {0};
    ...
    if(fp == NULL) {
        ...
        const char *p = data;
        long n = pSurf->u32Height * pSurf->u32Width*3/2;
