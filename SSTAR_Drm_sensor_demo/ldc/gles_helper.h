...
int gles_process(GLES_LDC_MODULE *module, int32_t curFrame, EGLImageKHR *texImage);
...
void generate_vertex_and_texcoord(GLES_LDC_MODULE *module, void *mapX, void *mapY,
                        int32_t vertxStride, int32_t texStride);
...
void free_egl_framebuffer_info(EGL_FRAMEBUFFER_INFO *info);
#if defined(__cplusplus)
}
#endif
