...
一、编译说明：
    ...
    --> make clean; make TOOLCHAIN_VERSION=6.4.0 ENABLE_LDC=0 OR make clean; make TOOLCHAIN_VERSION=10.2.1 ENABLE_LDC=0
...
eg:
    ...
    当编译时指定ENABLE_LDC=1, sensor出流送给ldc, ldc处理后保存在./test_ldc.yuv, 分辨率1920x1080, 格式YUV420 NV12
