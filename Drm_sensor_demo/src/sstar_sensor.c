...
static int sstar_init_venc(buffer_object_t *buf_obj)
{
    ...
    *************************************************/
    ...
    stVencChnAttr.stVeAttr.stAttrH264e.u32PicWidth         = ALIGN_BACK(scl_out_width, ALIGN_NUM);
    stVencChnAttr.stVeAttr.stAttrH264e.u32PicHeight        = ALIGN_BACK(scl_out_height, ALIGN_NUM);
    stVencChnAttr.stVeAttr.stAttrH264e.u32MaxPicWidth      = ALIGN_BACK(scl_out_width, ALIGN_NUM);
    stVencChnAttr.stVeAttr.stAttrH264e.u32MaxPicHeight     = ALIGN_BACK(scl_out_height, ALIGN_NUM);
