        ...
        lv_color_t color)
{
    ...
    stBuf.phyAddr[0] = sstar_drmfb_va2pa(dest_buf);
    stBuf.u16Width = sstar_drmfb_get_xres();
    stBuf.u16Height = sstar_drmfb_get_yres();
    stBuf.u32Stride[0] = sstar_drmfb_get_xres() * sizeof(lv_color_t);
        ...
        lv_color_t color)
{
	...
	printf("__sstar_gfx_fill \n");
    __sstar_gfx_make_surface(sstar_drmfb_va2pa(dest_buf), sstar_drmfb_get_xres(), sstar_drmfb_get_yres(),
...
void sstar_bdma_copy(lv_color_t *dst, lv_color_t *src, lv_area_t *area)
{
	...
	printf("sstar_bdma_copy \n");
    stSrcBuf.pVirAddr[0] = src;
    stSrcBuf.phyAddr[0]  = sstar_drmfb_va2pa(src);
    stDstBuf.pVirAddr[0] = dst;
    stDstBuf.phyAddr[0]  = sstar_drmfb_va2pa(dst);

    stDstBuf.u16Width     = stSrcBuf.u16Width     = sstar_drmfb_get_xres();
    stDstBuf.u16Height    = stSrcBuf.u16Height    = sstar_drmfb_get_yres();
    stDstBuf.u32Stride[0] = stSrcBuf.u32Stride[0] = sstar_drmfb_get_xres() * sizeof(lv_color_t);
...
void sstar_cpu_copy(MI_GFX_Surface_t *stSrc, MI_GFX_Surface_t *stDst, MI_GFX_Rect_t *stSrcRect, MI_GFX_Rect_t *stDstRect)
{
	#if 0
	stDst->phyAddr = phy_addr;
    stDst->u32Width = width;
    stDst->u32Height = height;
    stDst->u32Stride = stride;
	#endif
}
void sstar_gfx_copy(lv_color_t *dst, lv_color_t *src, lv_area_t *area)
{
    ...
    MI_GFX_Surface_t stSrc = {0}, stDst = {0};
    MI_GFX_Rect_t stSrcRect = {0}, stDstRect = {0};
	printf("sstar_gfx_copy \n");
    __sstar_gfx_make_surface(sstar_drmfb_va2pa(dst), sstar_drmfb_get_xres(), sstar_drmfb_get_yres(),
            sstar_drmfb_get_xres() * sizeof(lv_color_t), sizeof(lv_color_t) << 3, &stDst);
    __sstar_gfx_make_surface(sstar_drmfb_va2pa(src), sstar_drmfb_get_xres(), sstar_drmfb_get_yres(),
            sstar_drmfb_get_xres() * sizeof(lv_color_t), sizeof(lv_color_t) << 3, &stSrc);
...
void sstar_gfx_blend_cb(lv_draw_ctx_t * draw_ctx, const lv_draw_sw_blend_dsc_t * dsc)
{
	...
	printf("sstar_gfx_blend_cb \n");
    lv_color_t * dest_buf = draw_ctx->buf;
    lv_coord_t dest_stride = sstar_drmfb_get_xres();
